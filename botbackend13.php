...
$vturl='http://redfoxdev.com/backend13/';
                              ...
                              if ($err) {
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer rEesAv2lMrlLDMK9XlwsRc0JH8FoBCYb6AdMfjDQAZ22vSMZJNKgPTom1kAVk2e2WD1/zn4UUQtwQS/8gh1TIG/N2jygKs5LADqgHPyYqgtnWBX6AV9tUjm2O9v+gEgl7G8Em2LHZctv5Ss2r/sL/QdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
...
//
  ...
  '
                      ...
                      $datax = [
                        'to' => 'C62f82f6891fec8a60255265564936f05',
                        'messages' => [$messagesx],
                      ];
