...
$vturl='http://redfoxdev.com/tembackend/';
...
if (!is_null($events['events'])) {
    ...
    $mmuri = $vturl."webservice.php?operation=query&sessionName=".$sidname."&sessionName=636dbd215a9cebe09e04e&query=select%20*%20from%20Minmax%20where%20id=%2742x8%27;";
                  ...
                  if($money <= $max && $money >= $min) {
                              ...
                              $curl = curl_init();
                                ...
                                curl_setopt_array($curl, array(
                                  CURLOPT_URL => "http://redfoxdev.com/tembackend/webservice.php",
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer q0vvyXT0SpBbyADrZo1rrXbN/rmAHI1gJ10AS30AwXmZWd6e35W/mya3LRQMlutDhr9x1GhU0A8L4e7XpGljQXWVM4gb3Ym5KBjVmxvJ0ZsiL+tosE4voV+8bRaZMWZGk5+EWiBoA9B32sdxv4PcDwdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
        ...
        echo "cURL Error #:" . $err;
                ...
                if ($err) {
                  echo "cURL Error #:" . $err;
                            ...
                            $datax = [
                              'to' => 'C441c50c340634db4275c3794156c3e9b',
                              'messages' => [$messagesx],
                            ];
...
🚩ถอนเงินแจ้งแอดมิน แปะ พพ. ไว้หลังปิด live โอนให้ทุกคน
  '
                      ...
                      $url = 'https://api.line.me/v2/bot/message/push';
                      $datax = [
                        'to' => 'C9c57356d339545f469b6ba3edae73585',
                        'messages' => [$messagesx],
                      ];
                      $postx = json_encode($datax);
                      $headers = array('Content-Type: application/json', 'Authorization: Bearer ' . $access_token);
