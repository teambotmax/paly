...
$sidname='364761495a87df1654ad0';
$vturl='http://redfoxdev.com/backend11/';
            ...
            if ($ix != 1 && $tx!=1) {
                  ...
                  if($money <= 200 && $money >=20) {
                              ...
                              curl_setopt_array($curl, array(
                                CURLOPT_URL => "http://redfoxdev.com/backend11/webservice.php",
                              ...
                              if ($err) {
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer tl7LFTGj9ICxDVwgZr/MwcQTNB4ouFQyQ2pJhPOJkqDy62lRyuKCJxosm97P/E3FvYe6qnZQx6h/pGf8XpAldV/E38PKAUUc/f7xoBhPwzQxojgNj4/dfya0w6LWNO7mlLyKA9pbyZ/+gLYGZsaGqAdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
...
//
    ...
    //สิ้นสุดแก้ไขผล
        ...
        if(strcmp($teststr,"id") == 0){
          ...
          $uriu = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bcenter%20Where%20id%20='39x3';";
...
♠️♥️กติกา♦️♣️
พิมพ์ T ตามด้วยขาที่จะเล่น แล้ว ขีด (-) จำนวนเงิน
เช่น T12-200 คือ แทงขา 1 และขา 2 ขาละ 200 บาท
...
🏧 ฝากเงิน 24 ชั่วโมง
  กสิกรไทย 0293178622
  พร้อมเพย์ 0805802183

เบญจวรรณ นุชเครือ บัญชึนี้เดียวเท่านั้น ❗️
...
🚩ถอนเงินแจ้งแอดมิน แปะ พพ. ไว้หลังปิด live
  '
                      ...
                      $datax = [
                        'to' => 'C821a3583b0ddddd454cdf812610c6466',
                        'messages' => [$messagesx],
                      ];
