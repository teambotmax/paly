...
$sidname='592a50365a8135dbd0441';
$vturl='http://redfoxdev.com/backend6/';
            ...
            if ($ix != 1 && $tx!=1) {
                  ...
                  if($money <= 200 && $money >=20) {
                              ...
                              curl_setopt_array($curl, array(
                                CURLOPT_URL => "http://redfoxdev.com/backend6/webservice.php",
                              ...
                              if ($err) {
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer O482bN3dfTj1NxJUL1dwtyOcXCN3yJONUsEh2bLKR+0A1xKZIDEdeTOY5bk2NY2EkhSsvepgbUTkNXnotDdXhj3Bn2Nk/1ytqFlwF0eVrd9L/dt1uJXKwl0d4LxIig3J1oO00LQZ8zLrsfkZBniETgdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
...
//
    ...
    //สิ้นสุดแก้ไขผล
        ...
        if(strcmp($teststr,"id") == 0){
          ...
          $uriu = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bcenter%20Where%20id%20='39x26';";
                  ...
                  if($gameStatus ==0){
                    ...
                    if ($err) {
                      ...
                      $messagesx = [
                        'type' => 'text',
                        // 'text' => 'แทงผู้เล่น'.$player.'จำนวน'.$money.'ชื่อผู้เล่น'.$username.'ยอดคงเหลือ'.$balance.'vid:'.$vid
                        'text' => '📣สมัครลงทะเบียนพิมพ์ “play”
♠️♥️กติกา♦️♣️
พิมพ์ T ตามด้วยขาที่จะเล่น แล้ว ขีด (-) จำนวนเงิน  เช่น T12-200 คือ แทงขา 1 และขา 2 ขาละ 200 บาท
😃สมาชิกใหม่ ฝากขั้นต่ำ 40 บาท ฝากเกิน 100 บาท ได้โบนัสเพิ่ม 10%  โบนัสสูงสุด 100 บาท
🏧ช่องทางการฝากเงิน 24 ชั่วโมง
      กสิกรไทย 0368655678
      พร้อมเพย์ 0958395246      🆓ค่าธรรมเนียม
🚩ถอนเงินแจ้งแอดมิน แปะ พพ. ไว้หลังปิด live โอนให้ทุกคน
  '
                      ...
                      $datax = [
                        'to' => 'Cfa06b3533f36865afa5d2dbfb41e8419',
                        'messages' => [$messagesx],
                      ];
