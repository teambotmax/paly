                    ...
                    if ($err) {
                      ...
                      $curl = curl_init();
                          ...
                          if ($err) {
                            ...
                            $uri = "http://redfoxdev.com/vtiger/webservice.php?operation=query&sessionName=41fd14e15a617f672c0fd&query=select%20*%20from%20%20Bcontrol%20Where%20id%20=%20'49x847';";
                            $response = \Httpful\Request::get($uri)->send();
                            // echo $response;
                            $xname1 = $response->body->result[0]->bcontrol_tks_etcone;
                            $xno1 = $response->body->result[0]->bcontrol_tks_exone;
                            $xname2 = $response->body->result[0]->bcontrol_tks_etctwo;
                            $xno2 = $response->body->result[0]->bcontrol_tks_extwo;
                            $xbonus = $response->body->result[0]->bcontrol_tks_exfive;
...
0338744064'
                            ...
                            $datax = [
                              'to' => 'Cca381c9e900f6160c241121e1496ca9d',
                              'messages' => [$messagesx],
                            ];
