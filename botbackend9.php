...
$vturl='http://redfoxdev.com/backend9/';
...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
      ...
      $lentext = strlen($newtext);
        ...
        //gamestatus
        $uri = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bgame%20Where%20id%20='37x4';";
            ...
            if ($ix != 1 && $tx!=1) {
                  ...
                  if($money <= 200 && $money >=20) {
                              ...
                              curl_setopt_array($curl, array(
                                CURLOPT_URL => "http://redfoxdev.com/backend9/webservice.php",
                              ...
                              if ($err) {
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer UZqjRvu9v2MTO1399HElHqLBKtjufGT0zSuWEXEllBNx2mmfnKD1f2v1Ypxg9j3l7ivUBGZd9qmegEp1sUVlC2gEn8TPyiTki0GTS043FQgh4fkXvlSE0WztEFYeK2pVLAO9cBgpJu6V7wOWMgNVJAdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
...
♠️♥️มาเล่นบ้านJamesbond001♦️♣️
 เรามีโบนัสแจกให้ด้วยนะคะ😊'
        ...
        $uriu = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bcenter%20Where%20id%20='39x80';";
...
//
      ...
      $uriad = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bgame%20Where%20id%20='37x4';";
          ...
          $adminID = $response->body->result[0]->bgame_tks_adminid;
            ...
            if(strcmp($adminID,$userID) == 0 && $onresult == 1){
              ...
              foreach($datax["result"] as $itemx) {
                  ...
                  $urit = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bgame%20Where%20id%20='37x4';";
...
🏧 ฝากเงิน 24 ชั่วโมง
  กสิกรไทย 0372523913
  พร้อมเพย์ 0644731049
🚩ถอนเงินแจ้งแอดมิน แปะ พพ. ไว้หลังปิด live'
                      ];


                      $url = 'https://api.line.me/v2/bot/message/push';
                      $datax = [
                        'to' => 'C3833dcc18ae068de670755c289ff8168',
                        'messages' => [$messagesx],
                      ];
