      ...
      if(strlen($usernamex)>0){
            if ($ix != 1 && $tx!=1) {
                              ...
                              if ($err) {
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer g8q749ofK3UGohe8P3q61XuqTr8G0TPqhSn7nlGPM7AAR/Q7/ora1e0GX+lbCxeyXyOCZy9IrTvfE733WIlqXcfHfs7BSWdF4KDibzDUym9ZGyLwDPrrUvMXuK5X0X6K7lp27eIHq6SXoCiQkdEpjgdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
                  ...
                  $messages = [
                    'type' => 'text',
                    // 'text' => 'แทงผู้เล่น'.$player.'จำนวน'.$money.'ชื่อผู้เล่น'.$username.'ยอดคงเหลือ'.$balance.'vid:'.$vid
                    'text' => 'รูปแบบการแทงไม่ถูกต้อง แทงได้แค่ T1 - T4 เท่านั้น ต่ำสุด 20 สูงสุด 400  ตัวอย่าง : T1234-50 หรือ T1-200'
                  ];
...
//
      ...
      $uriad = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bgame%20Where%20id%20='37x2';";
...
🚩ถอนเงินแจ้งแอดมิน แปะ พพ. ไว้หลังปิด live'
                      ...
                      $datax = [
                        'to' => 'Cc8e4f0efce53350091375fbb0ba84ac6',
                        'messages' => [$messagesx],
                      ];
